...
import { GenerateBlogPostForm } from "../../components/Inputs/GenerateBlogPostForm";
...
const BlogPostEditor = ({ isEdit }) => {
  ...
  const generatePostIdeas = async () => {
    ...
    try {
      ...
      const generatedIdeas = aiResponse.data.data;
          ...
          <div className="form-card p-6 col-span-12 md:col-span-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {isEdit && (
                  <button
                    className="flex items-center text-sm gap-2.5 font-medium text-rose-500 bg-rose-50/60 rounded px-1.5 md:px-3 py-1 md:py-[3px] border border-rose-50 hover:border-rose-300 cursor-pointer hover:scale-[1.02] transition-all"
                    disabled={loading}
                ...
                <button
                  className="flex items-center text-sm gap-2.5 font-medium text-sky-500 bg-sky-50/60 rounded px-1.5 md:px-3 py-1 md:py-[3px] border border-sky-50 hover:border-sky-400 cursor-pointer hover:scale-[1.02] transition-all"
                  disabled={loading}
                ...
                <button
                  className="flex items-center text-sm gap-2.5 font-medium text-sky-600 hover:text-white hover:bg-linear-to-r hover:from-sky-500 hover:to-indigo-500 rounded px-3 py-1 md:py-[3px] border border-sky-500 hover:border-sky-50 cursor-pointer transition-all"
                  disabled={loading}
          ...
          {!isEdit && (
            <div className="form-card col-span-12 md:col-span-4 p-0">
              <div className="flex items-center justify-between px-6 pt-6">
                <h4 className="text-base md:text-lg font-medium inline-flex items-center gap-2">
                ...
                <button
                  className="bg-linear-to-r from-sky-500  to-cyan-400 text-sm font-semibold text-white px-3 py-1 rounded hover:bg-black hover:text-white transition-colors cursor-pointer hover:shadow-2xl hover:shadow-sky-200"
                  onClick={() =>
