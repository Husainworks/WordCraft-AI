      ...
      >
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2.5 mt-2 flex-wrap">
            <div className="text-xs text-gray-700 font-medium bg-gray-100 px-2.5 py-1 rounded">
              Updated: {updatedOn}
            </div>
            ...
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1.5 text-xs text-sky-700 font-medium bg-sky-50 px-2.5 py-1 rounded">
                <LuEye className="text-base text-sky-500" /> {views}
              </span>

              <span className="flex items-center gap-1.5 text-xs text-sky-700 font-medium bg-sky-50 px-2.5 py-1 rounded">
                <LuHeart className="text-base text-sky-500" /> {likes}
              </span>
            </div>
