...
const SideMenu = ({ activeMenu, isBlogMenu, setOpenSideMenu }) => {
  ...
  return (
    <>
      <div className="w-64 h-[calc(100vh-80px)] bg-white border-r border-gray-200/50 p-5 sticky top-[75px] z-20">
        {user && (
          <div className="flex flex-col items-center justify-center gap-1 mt-3 mb-7 ">
            ...
            <div>
              ...
              <p className="text-gray-800 text-[13px] font-medium text-center">
                {user?.email || ""}
              </p>
            </div>
          </div>
